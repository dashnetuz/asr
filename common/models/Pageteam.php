...
/**
 * This is the model class for table "pageteam".
 *
 * @property int $id
 ...
 */
class Pageteam extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['page_id', 'fullname', 'fullname_ru', 'fullname_en', 'url', 'url_ru', 'url_en', 'meta_fullname', 'meta_fullname_ru', 'meta_fullname_en',
    ...
    public function getAvatar(){
            return '/backend/web/uploads/pageteam/icon/' . $this->filename;
    }
