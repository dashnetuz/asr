...
/**
 * PagesSearch represents the model behind the search form of `common\models\Chair`.
 */
class MajorSearch extends Major
{
    ...
    {
        return [
            [['id', 'chair_id', 'status', 'child_id', 'parent_id', 'user_id', 'created_at'], 'integer'],

            [['title', 'title_ru', 'title_en', 'url', 'url_ru', 'url_en', 'meta_title', 'meta_title_ru',
                'meta_title_en', 'meta_description', 'meta_description_ru', 'meta_description_en', 'filename'], 'safe'],
        ];
    }
