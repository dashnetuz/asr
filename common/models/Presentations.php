...
class Presentations extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['title', 'title_ru', 'title_en', 'files', 'icon',
//                'url', 'url_ru', 'url_en', 'meta_title', 'meta_title_ru', 'meta_title_en', 'meta_description', 'meta_description_ru', 'meta_description_en',
            ...
            ['files', 'file', 'extensions' => ['ppt', 'pptx', 'pdf'], 'skipOnEmpty' => true],
            ['icon', 'file', 'extensions' => ['ppt', 'pptx', 'pdf'], 'skipOnEmpty' => true],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'files' => Yii::t('app', 'File "ppt, pptx, pdf"'),
        ];
    }
}
