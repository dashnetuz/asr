...
/**
 * This is the model class for table "pagepdf".
 *
 * @property int $id
 ...
 */
class Pagepdf extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['page_id','title', 'title_ru', 'title_en', 'url', 'url_ru', 'url_en', 'meta_title', 'meta_title_ru', 'meta_title_en', 'filename', 'status', 'child_id', 'parent_id', 'user_id', 'created_at'], 'required'],
