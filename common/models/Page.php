...
class Page extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['pages_id','title', 'title_ru', 'title_en', 'url', 'url_ru', 'url_en', 'meta_title', 'meta_title_ru', 'meta_title_en', 'meta_description', 'meta_description_ru', 'meta_description_en', 'filename', 'status', 'child_id', 'parent_id', 'user_id', 'created_at'], 'required'],
    ...
    {
        return $this->hasOne(Pages::class, ['id' => 'pages_id']);
    }
