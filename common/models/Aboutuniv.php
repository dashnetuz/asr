...
/**
 * This is the model class for table "aboutuniv".
 *
 * @property int $id
 ...
 */
class Aboutuniv extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['pages_id','title', 'title_ru', 'title_en', 'url', 'url_ru', 'url_en', 'meta_title', 'meta_title_ru', 'meta_title_en','description', 'description_ru', 'description_en', 'meta_description', 'meta_description_ru', 'meta_description_en', 'filename', 'status', 'child_id', 'parent_id', 'user_id', 'created_at'], 'required'],
            ...
            [['description', 'description_ru', 'description_en'], 'string', 'max' => 1000],
            [['pages_id', 'status', 'child_id', 'parent_id', 'user_id', 'created_at'], 'integer'],
...
//    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'picture' => Yii::t('app', 'Picture 1920x800'),
        ];
    }
}
