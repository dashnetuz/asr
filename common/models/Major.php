...
class Major extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['chair_id','title', 'title_ru', 'title_en', 'url', 'url_ru', 'url_en', 'meta_title', 'meta_title_ru', 'meta_title_en', 'meta_description', 'meta_description_ru', 'meta_description_en', 'status', 'child_id', 'parent_id', 'user_id', 'created_at'], 'required'],
            ...
            [['chair_id', 'status', 'child_id', 'parent_id', 'user_id', 'created_at'], 'integer'],
...
//    }
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
            'chair_id' => Yii::t('app', 'Kafedrasi nomi'),
            'title' => Yii::t('app', 'Yo`nalish nomi UZ'),
            'title_ru' => Yii::t('app', 'Yo`nalish nomi Ru'),
            'title_en' => Yii::t('app', 'Yo`nalish nomi En'),
            'url' => Yii::t('app', 'Url'),
            ...
            'meta_description' => Yii::t('app', 'Yo`nalish tarixi O`zbekcha'),
            'meta_description_ru' => Yii::t('app', 'Yo`nalish tarixi Ruscha'),
            'meta_description_en' => Yii::t('app', 'Yo`nalish tarixi Inglizcha'),
