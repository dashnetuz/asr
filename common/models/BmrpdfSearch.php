...
use common\models\Bmrpdf;

/**
 * BmrpdfSearch represents the model behind the search form of `common\models\Bmrpdf`.
 */
class BmrpdfSearch extends Bmrpdf
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['title', 'title_ru', 'title_en', 'url', 'url_ru', 'url_en', 'meta_title', 'meta_title_ru', 'meta_title_en', 'description', 'description_ru', 'description_en', 'meta_description', 'meta_description_ru', 'meta_description_en', 'filename'], 'safe'],
        ];
    }
