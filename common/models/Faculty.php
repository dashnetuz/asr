...
class Faculty extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['title', 'title_ru', 'title_en', 'url', 'url_ru', 'url_en', 'meta_title', 'meta_title_ru', 'meta_title_en', 'meta_description', 'meta_description_ru', 'meta_description_en', 'status', 'child_id', 'parent_id', 'user_id', 'created_at'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
            'title' => Yii::t('app', 'Fakultet nomi Uz'),
            'title_ru' => Yii::t('app', 'Fakultet nomi Ru'),
            'title_en' => Yii::t('app', 'Fakultet nomi En'),
            'url' => Yii::t('app', 'Url'),
            ...
            'meta_description' => Yii::t('app', 'Fakultet tarixi O`zbekcha'),
            'meta_description_ru' => Yii::t('app', 'Fakultet tarixi Ruscha'),
            'meta_description_en' => Yii::t('app', 'Fakultet tarixi Inglizcha'),
