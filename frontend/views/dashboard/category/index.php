    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                ...
                <?= Html::a(Yii::t('app', 'Tartibni o‘zgartirish'), ['dashboard/category-position'], [
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered text-nowrap align-middle w-100" style="table-layout: fixed;">
                    ...
                    <tr>
                        ...
                        <th style="width: 20%;"><?= Yii::t('app', 'Rasm va nom') ?></th>
                    ...
                    <?php foreach ($models as $item): ?>
                        <tr>
                            <td class="text-wrap" style="word-break: break-word;">#<?= $item->position ?></td>
                            ...
                            <td class="text-center text-wrap" style="word-break: break-word;">
                                <div class="action-btn d-flex justify-content-center gap-2">
                                    <?= Html::a('<i class="ti ti-list-details fs-5"></i>', ['dashboard/course-index', 'category_id' => $item->id], [
                                        'class' => 'text-info', 'title' => Yii::t('app', 'Kurslar ro‘yxati')
                                    ]) ?>
                                    <?= Html::a('<i class="ti ti-eye fs-5"></i>', ['dashboard/category-update', 'id' => $item->id], [
                                        'class' => 'text-primary', 'title' => Yii::t('app', 'Tahrirlash')
                                    ]) ?>
                                    <?= Html::a('<i class="ti ti-trash fs-5"></i>', ['dashboard/category-delete', 'id' => $item->id], [
